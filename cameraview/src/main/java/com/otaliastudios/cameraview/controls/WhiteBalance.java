...
public enum WhiteBalance implements Control {
    ...
    /**
     * White balance appropriate for pictures in TWILIGHT conditions.
     * This is not guaranteed to be supported.
     *
     * @see CameraOptions#getSupportedWhiteBalance()
     */
    ...
    /**
     * White balance appropriate for pictures in SHADE conditions.
     * This is not guaranteed to be supported.
     *
     * @see CameraOptions#getSupportedWhiteBalance()
     */
    ...
    /**
     * White balance appropriate for pictures in WARM_FLUORESCENT conditions.
     * This is not guaranteed to be supported.
     *
     * @see CameraOptions#getSupportedWhiteBalance()
     */
