...
public class Camera2Mapper {
    ...
    static {
        ...
        WB.put(WhiteBalance.TWILIGHT, CameraCharacteristics.CONTROL_AWB_MODE_TWILIGHT);
        WB.put(WhiteBalance.SHADE, CameraCharacteristics.CONTROL_AWB_MODE_SHADE);
        WB.put(WhiteBalance.WARM_FLUORESCENT, CameraCharacteristics.CONTROL_AWB_MODE_WARM_FLUORESCENT);
