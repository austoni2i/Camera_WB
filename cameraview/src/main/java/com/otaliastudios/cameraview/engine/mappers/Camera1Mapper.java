...
public class Camera1Mapper {
    ...
    static {
        ...
        WB.put(WhiteBalance.TWILIGHT, Camera.Parameters.WHITE_BALANCE_TWILIGHT);
        WB.put(WhiteBalance.SHADE, Camera.Parameters.WHITE_BALANCE_SHADE);
        WB.put(WhiteBalance.WARM_FLUORESCENT, Camera.Parameters.WHITE_BALANCE_WARM_FLUORESCENT);
